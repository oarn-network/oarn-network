...
async function main() {
  ...
  md += `> [Register your wallet →](https://forms.gle/placeholder-registration) | [Referral form →](https://forms.gle/placeholder-referral) | [Rewards program details →](../plans/testnet-rewards-program.md)\n\n`;
